...
export default function App() {
  ...
  const { results, rawResults, loading: resultsLoading, reloadMatch } = useMatchResults(matches);
  ...
  return (
    <div className="app">
      ...
      <main className="main">
        ...
        {!loading && !error && (
          <MatchList matches={filtered} events={events} results={results} rawResults={rawResults} resultsLoading={resultsLoading} reloadMatch={reloadMatch} />
        )}
      </main>
    </div>
  );
